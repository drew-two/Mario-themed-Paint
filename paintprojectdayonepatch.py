...
while running:
    ...
    if tool == "": #startup caption
        display.set_caption("Left click speaker in top right to pause/play music, and scroll mouse wheel to change tool size.") #opening instructions
...
#===================Rectangular Hitboxes====================
    ...
    stampRect=Rect(250,560,780,208)
...
#=====================Tool/Stamp/File Parameters=====================
    ...
    if toolRect.collidepoint(mx,my):
        ...
        if penRect.collidepoint(mx,my)==False and sprayRect.collidepoint(mx,my)==False and eraserRect.collidepoint(mx,my)==False and dropRect.collidepoint(mx,my)==False and rectRect.collidepoint(mx,my)==False and textRect.collidepoint(mx,my)==False and ellipRect.collidepoint(mx,my)==False and lineRect.collidepoint(mx,my)==False:
            ...
            if tool =="line":
                ...
                screen.blit(starmanblank,(759,624))
                screen.blit(upblank,(881,624))
            if tool!= "pencil" and tool!="spraycan" and tool!="eraser" and tool!="drop" and tool!="rect" and tool!="text" and tool!="ellip" and tool!="line":
                screen.blit(penblank,(6,121))
                screen.blit(sprayblank,(93,121))
                screen.blit(eraserblank,(6,245))
                screen.blit(dropblank,(92,245))
                ...
                screen.blit(ellipblank,(7,491))
                screen.blit(lineblank,(93,491))
    elif stampRect.collidepoint(mx,my): #display used stamp(s)
        ...
        if marioRect.collidepoint(mx,my)==False and luigiRect.collidepoint(mx,my)==False and mushroomRect.collidepoint(mx,my)==False and fireflowerRect.collidepoint(mx,my)==False and starmanRect.collidepoint(mx,my)==False and upRect.collidepoint(mx,my)==False:
            if tool=="mario":
                screen.blit(penblank,(6,121))
                screen.blit(sprayblank,(93,121))
                screen.blit(eraserblank,(6,245))
            ...
            if tool=="1up":
                ...
                screen.blit(fireflowerblank,(638,624))
                screen.blit(starmanblank,(759,624))
            if tool!="mario" and tool!="luigi" and tool!="mushroom" and tool!="fireflower" and tool!="starman" and tool!="1up":
                screen.blit(marioblank,(276,624))
                screen.blit(luigiblank,(396,624))
                screen.blit(mushroomblank,(517,624))
                screen.blit(fireflowerblank,(638,624))
    ...
    elif fileRect.collidepoint(mx,my): #shows if save or open is highlighted/used
...
#======================Color Wheel=======================                
    ...
    if mb[0]==1 and (((mx-78)**2+(my-682)**2)**0.5)<78 :
        ...
        draw.rect(screen,col,(167,672,78,78)) #Fills box with current selected color.
...
#============================Tools===============================
    ...
    if tool=="spraycan":
        ...
        if canvasRect.collidepoint(mx,my) and mb[0]==1:
            ...
            x=randint(mx-spraysize,mx+spraysize)
            y=randint(my-spraysize,my+spraysize)
            if ((mx-x)**2+(my-y)**2)**0.5 < spraysize :
                draw.circle(screen,col,(x,y),0)
...
#================Saving and Opening=================
    ...
    if saveRect.collidepoint(mx,my) and mb[0]==1: #click on save button
        ...
        root.withdraw()
        if len(tkintsave)>0:
            image.save(screen.subsurface(canvasRect),tkintsave) #pygame saves the copy with tkinters chosen file name
            root.withdraw()
